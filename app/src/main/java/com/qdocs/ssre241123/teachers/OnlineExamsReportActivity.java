...
/**
 * Online Exam Report Activity
 * API: online-exams-report/filter
 */
public class OnlineExamsReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "online-exams-report/filter";
        titleField = "exam";
        subtitleField = "class";
        detailField = "subject";
        ...
        titleTextView.setText("Online Exams Report");
