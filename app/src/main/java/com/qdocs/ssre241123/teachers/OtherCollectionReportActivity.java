...
/**
 * Activity for Other Collection Report
 ...
 */
public class OtherCollectionReportActivity extends BaseFinanceReportActivity {

    private static final String TAG = "OtherCollectionReport";
    ...
    protected int getLayoutResourceId() {
        return R.layout.activity_other_collection_report;
    }

    @Override
    protected String getReportTitle() {
        return getString(R.string.other_collection_report);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize currency
        currency = com.qdocs.ssre241123.utils.Utility.getSharedPreferences(
        ...
        com.android.volley.toolbox.StringRequest request = new com.android.volley.toolbox.StringRequest(
            ...
            new com.android.volley.Response.ErrorListener() {
                ...
                public void onErrorResponse(com.android.volley.VolleyError error) {
                    ...
                    Log.e(TAG, "========================================");
                    Toast.makeText(OtherCollectionReportActivity.this,
    ...
    protected String buildRequestBody() {
        try {
            ...
            android.util.Log.e(TAG, "Error creating request body", e);
            return "{}";
        }
    }
