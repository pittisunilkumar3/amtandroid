...
/**
 * External Result Report Activity
 * API: external-result-report/get-report
 */
public class ExternalResultReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "external-result-report/get-report";
        ...
        titleTextView.setText("External Result Report");
