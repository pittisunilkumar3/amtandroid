...
/**
 * Student Academic Report Activity
 * API: student-academic-report/filter
 */
public class StudentAcademicReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "student-academic-report/filter";
        ...
        titleTextView.setText("Student Academic Report");
