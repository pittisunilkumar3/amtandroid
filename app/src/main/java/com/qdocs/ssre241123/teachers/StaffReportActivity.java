 ...
 * Shows all staff/employee details
 * API: staff-report/filter
 */
public class StaffReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "staff-report/filter";
        titleField = "name";
        subtitleField = "employee_id";
        ...
        titleTextView.setText("Staff Report");
