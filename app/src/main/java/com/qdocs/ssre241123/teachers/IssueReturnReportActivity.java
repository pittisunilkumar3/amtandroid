...
/**
 * Issue Return Report Activity
 * API: issue-return-report/filter
 */
public class IssueReturnReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "issue-return-report/filter";
        titleField = "item_name";
        subtitleField = "issuer_name";
        detailField = "return_date";
        ...
        titleTextView.setText("Issue Return Report");
