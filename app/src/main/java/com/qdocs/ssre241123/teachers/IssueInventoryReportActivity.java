...
/**
 * Issue Inventory Report Activity
 * API: issue-inventory-report/filter
 */
public class IssueInventoryReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "issue-inventory-report/filter";
        titleField = "item_name";
        subtitleField = "issued_to";
        detailField = "issue_date";
        ...
        titleTextView.setText("Issue Inventory Report");
