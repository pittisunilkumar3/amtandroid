...
/**
 * Teacher Syllabus Status Report Activity
 * API: teacher-syllabus-status-report/filter
 */
public class TeacherSyllabusStatusReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "teacher-syllabus-status-report/filter";
        titleField = "subject";
        ...
        titleTextView.setText("Teacher Syllabus Status Report");
