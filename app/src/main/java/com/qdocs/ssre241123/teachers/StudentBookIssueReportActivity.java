...
/**
 * Student Book Issue Report Activity
 * API: student-book-issue-report/filter
 */
public class StudentBookIssueReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "student-book-issue-report/filter";
        ...
        titleTextView.setText("Student Book Issue Report");
