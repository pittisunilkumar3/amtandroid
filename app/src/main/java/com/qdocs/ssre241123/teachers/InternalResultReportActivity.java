...
/**
 * Internal Result Report Activity
 * API: internal-result-report/get-report
 */
public class InternalResultReportActivity extends GenericReportActivity {
    @Override
    protected void initViews() {
        apiEndpoint = "internal-result-report/get-report";
        ...
        titleTextView.setText("Internal Result Report");
