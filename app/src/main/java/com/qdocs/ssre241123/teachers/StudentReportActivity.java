...
import com.qdocs.ssre241123.adapters.StudentReportAdapter;
...
public class StudentReportActivity extends TeacherReportDetailActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new StudentReportAdapter(this, studentList);
    ...
    protected void loadReportData() {
        ...
        showLoading();
        fetchStudentReport(sessionId, classId, sectionId);
    }

    private void fetchStudentReport(String sessionId, String classId, String sectionId) {
        String baseUrl = Utility.getSharedPreferences(getApplicationContext(), "apiUrl");
        String url = baseUrl + "student-report/filter";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        hideLoading();
                        parseStudentReportResponse(response);
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        String errorMessage = "Error loading student report";
                        ...
                        Toast.makeText(StudentReportActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        showNoData();
                    }
                }) {
    ...
    private void parseStudentReportResponse(String response) {
        try {
            ...
            if (status == 1) {
                ...
                if (dataArray != null && dataArray.length() > 0) {
                    ...
                    for (int i = 0; i < dataArray.length(); i++) {
                        ...
                        StudentReportModel student = new StudentReportModel();
                        ...
                        student.setCategoryName(studentObj.optString("category", ""));
                        student.setFatherName(studentObj.optString("father_name", ""));
                        student.setDob(studentObj.optString("dob", ""));
                        ...
                        student.setSamagraId(studentObj.optString("samagra_id", ""));
                        student.setAdharNo(studentObj.optString("adhar_no", ""));
                        student.setRte(studentObj.optString("rte", ""));
                        ...
                        student.setCurrentAddress(studentObj.optString("current_address", ""));
                        student.setPermanentAddress(studentObj.optString("permanent_address", ""));
                    ...
                    String message = "Found " + totalRecords + " student(s)";
                    Log.d(TAG, "Success message: " + message);
                    Toast.makeText(this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Log.w(TAG, "Data array is null or empty");
                    showNoData();
                    Toast.makeText(this, "No students found for selected filters", Toast.LENGTH_SHORT).show();
                }
            } else {
                String message = jsonObject.optString("message", "Failed to load student report");
            ...
            e.printStackTrace();
            Toast.makeText(this, "Error parsing student data: " + e.getMessage(), Toast.LENGTH_LONG).show();
            showNoData();
        }
    }
}
